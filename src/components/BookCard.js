        ...
        <div class="book-card">
            ...
            <div class="flex-1 h-full pr-2 pt-2 flex flex-col">
              <div class="flex items-center justify-between">
                <span class={`${featured && "badge-success lws-Badge"}`}>{featured && "featured"}</span>
              ...
              <div class="space-y-2 mt-4 h-full">
                ...
                <div class="lws-stars">
                  ...
                  { 
                    [...Array(rating).keys()].map((r ,i) => r < 5 && <svg key={i} viewBox="0 0 20 20" fill="currentColor" class="lws-star">
